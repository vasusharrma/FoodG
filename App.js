...
const Fa_Cards = (props) => {
     console.log("I am inside the function");

    return(
        <div className="fa_card">
            <div className="fa_card_img">
                <img alt='fa-image' src={'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/'+props.resData.data.cloudinaryImageId}/>
            </div>
        ...
        <div className="fa_body">
           <div className="fa_serach">
            ...
            <div className="fa_container">
                {
                    faData.map((restaurant) => (<Fa_Cards key={restaurant.data.id} resData={restaurant} />))
                }
            </div>
        </div>
    )
